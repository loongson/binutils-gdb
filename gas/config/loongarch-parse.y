...
reloc (const char *op_c_str, const char *id_c_str, offsetT addend)
{
  ...
  if (0)
    /* unreachable */ ;
//SET_RELOC_TYPE_ON_TOP ("abs", SOP_PUSH_ABSOLUTE);
//SET_RELOC_TYPE_ON_TOP ("pcrel", SOP_PUSH_PCREL);
//SET_RELOC_TYPE_ON_TOP ("gprel", SOP_PUSH_GPREL);
//SET_RELOC_TYPE_ON_TOP ("tprel", SOP_PUSH_TLS_TPREL);
//SET_RELOC_TYPE_ON_TOP ("tlsgot", SOP_PUSH_TLS_GOT);
//SET_RELOC_TYPE_ON_TOP ("tlsgd", SOP_PUSH_TLS_GD);
//SET_RELOC_TYPE_ON_TOP ("plt", SOP_PUSH_PLT_PCREL);

  SET_RELOC_TYPE_ON_TOP ("l_hi20", ABS_L_HI20);
  SET_RELOC_TYPE_ON_TOP ("l_lo12", ABS_L_LO12);
  SET_RELOC_TYPE_ON_TOP ("h_lo20", ABS_H_LO20);
  SET_RELOC_TYPE_ON_TOP ("h_hi12", ABS_H_HI12);
  SET_RELOC_TYPE_ON_TOP ("pcrel32_hi20", PCREL32_HI20);
  SET_RELOC_TYPE_ON_TOP ("pcrel38_hi", PCREL38_HI20);
  SET_RELOC_TYPE_ON_TOP ("pcrel64_hi20", PCREL64_L_HI20);
  ...
  SET_RELOC_TYPE_ON_TOP ("got64_hi20", GOT64_L_HI20);
  SET_RELOC_TYPE_ON_TOP ("ie32_hi20", TLSIE32_HI20);
  SET_RELOC_TYPE_ON_TOP ("ie64_hi20", TLSIE64_L_HI20);
  SET_RELOC_TYPE_ON_TOP ("lel_hi20", TLSLE64_L_HI20);
  SET_RELOC_TYPE_ON_TOP ("lel_lo12", TLSLE64_L_LO12);
  SET_RELOC_TYPE_ON_TOP ("leh_lo20", TLSLE64_H_LO20);
  SET_RELOC_TYPE_ON_TOP ("leh_hi12", TLSLE64_H_HI12);
  SET_RELOC_TYPE_ON_TOP ("gd32_hi20", TLSGD32_HI20);
  SET_RELOC_TYPE_ON_TOP ("gd64_hi20", TLSGD64_L_HI20);
  SET_RELOC_TYPE_ON_TOP ("bl26", BL26);
  SET_RELOC_TYPE_ON_TOP ("b16", B16);
  SET_RELOC_TYPE_ON_TOP ("b21", B21);
  SET_RELOC_TYPE_ON_TOP ("b26", B26);
  SET_RELOC_TYPE_ON_TOP ("pcrel38_lo", JIRL);
