...
static struct loongarch_opcode loongarch_macro_opcodes[] =
{
  ...
  { 0, 0, "la.tls.le",	"r,la",	  INSN_LA_TLS_LE,		0 },
  { 0, 0, "la.tls.le",	"r,la",	  INSN_LA_TLS_LE64_LARGE,	0 },
  { 0, 0, "la.tls.ie",	"r,la",	  INSN_LA_TLS_IE32,		0 },
  { 0, 0, "la.tls.ie",	"r,la",	  INSN_LA_TLS_IE64,		0 },
  { 0, 0, "la.tls.ie",	"r,la",	  INSN_LA_TLS_IE64_LARGE_ABS,	0 },
  { 0, 0, "la.tls.ie",	"r,r,la", INSN_LA_TLS_IE64_LARGE_PCREL,	0 },
  { 0, 0, "la.tls.ld",	"r,la",	  INSN_LA_TLS_LD32,		0 },
  { 0, 0, "la.tls.ld",	"r,la",	  INSN_LA_TLS_LD64,		0 },
  { 0, 0, "la.tls.ld",	"r,la",	  INSN_LA_TLS_LD64_LARGE_ABS,	0 },
  { 0, 0, "la.tls.ld",	"r,r,la", INSN_LA_TLS_LD64_LARGE_PCREL,	0 },
  { 0, 0, "la.tls.gd",	"r,la",	  INSN_LA_TLS_GD32,		0 },
  { 0, 0, "la.tls.gd",	"r,la",	  INSN_LA_TLS_GD64,		0 },
  { 0, 0, "la.tls.gd",	"r,la",	  INSN_LA_TLS_GD64_LARGE_ABS,	0 },
  { 0, 0, "la.tls.gd",	"r,r,la", INSN_LA_TLS_GD64_LARGE_PCREL,	0 },
