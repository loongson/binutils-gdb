...
#define LOONGARCH_HOWTO_2(X, bitsz, pcrel, bitpos, dstmsk)		      \
  { HOWTO (R_LARCH_##X, 0, 2, bitsz, pcrel, bitpos, complain_overflow_signed, \
	 bfd_elf_generic_reloc, "R_LARCH_"#X, 0, 0, dstmsk, 0), 	      \
	 BFD_RELOC_LARCH_##X, NULL }
  /* type 64-84.  */
  LOONGARCH_HOWTO_2(ABS_L_HI20, 20, false, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(ABS_L_LO12, 12, false, 10, 0x3ffc00),
  LOONGARCH_HOWTO_2(ABS_H_LO20, 20, false, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(ABS_H_HI12, 12, false, 10, 0x3ffc00),
  LOONGARCH_HOWTO_2(PCREL32_HI20, 20, true, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(PCREL38_HI20, 20, 1, 5, 0x1ffffe0),
  LOONGARCH_HOWTO_2(PCREL64_L_HI20, 20, true, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(PCREL_LO12_U, 12, false, 10, 0x3ffc00),
  LOONGARCH_HOWTO_2(PCREL_LO12_S, 12, false, 10, 0x3ffc00),
  LOONGARCH_HOWTO_2(PCREL_H_LO20, 20, false, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(PCREL_H_HI12, 12, false, 10, 0x3ffc00),
  LOONGARCH_HOWTO_2(GOT32_HI20, 20, true, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(GOT64_L_HI20, 20, true, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(TLSIE32_HI20, 20, true, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(TLSIE64_L_HI20, 20, true, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(TLSLE64_L_HI20, 20, false, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(TLSLE64_L_LO12, 12, false, 10, 0x3ffc00),
  LOONGARCH_HOWTO_2(TLSLE64_H_LO20, 20, false, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(TLSLE64_H_HI12, 12, false, 10, 0x3ffc00),
  LOONGARCH_HOWTO_2(TLSGD32_HI20, 20, true, 5, 0x1fffe0),
  LOONGARCH_HOWTO_2(TLSGD64_L_HI20, 20, true, 5, 0x1fffe0),

  LOONGARCH_HOWTO (R_LARCH_B16,	      			/* type (85).  */
	 2,				   	/* rightshift.  */
	 2,				   	/* size.  */
	 16,				  	/* bitsize.  */
	 false,					/* pc_relative.  */
  ...
  LOONGARCH_HOWTO (R_LARCH_B21,                           /* type (86).  */
         2,                                     /* rightshift.  */
         2,                                     /* size.  */
         21,                                    /* bitsize.  */
         1,                                  /* pc_relative.  */
  ...
  LOONGARCH_HOWTO (R_LARCH_B26,                           /* type (87).  */
         2,                                     /* rightshift.  */
         2,                                     /* size.  */
         26,                                    /* bitsize.  */
         1,                                  /* pc_relative.  */
  ...
  LOONGARCH_HOWTO (R_LARCH_BL26,                          /* type (88).  */
         2,                                     /* rightshift.  */
         2,                                     /* size.  */
         26,                                    /* bitsize.  */
         1,                                  /* pc_relative.  */
  ...
  LOONGARCH_HOWTO (R_LARCH_JIRL,	      			/* type (89).  */
	 2,				   	/* rightshift.  */
	 2,				   	/* size.  */
	 16,				  	/* bitsize.  */
	 1,					/* pc_relative.  */
	 ...
	 0xfc0003ff,				/* dst_mask */
	 0,			      	/* pcrel_offset.  */
	 BFD_RELOC_LARCH_JIRL,	  		/* bfd_reloc_code_real_type */
	 loongarch_gen_adjust_reloc_bits),	/* adjust_reloc_bits */
