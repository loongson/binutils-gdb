...
RELOC_NUMBER (R_LARCH_ABS_L_HI20, 64)
RELOC_NUMBER (R_LARCH_ABS_L_LO12, 65)
RELOC_NUMBER (R_LARCH_ABS_H_LO20, 66)
RELOC_NUMBER (R_LARCH_ABS_H_HI12, 67)
RELOC_NUMBER (R_LARCH_PCREL32_HI20, 68)
RELOC_NUMBER (R_LARCH_PCREL38_HI20, 69)
RELOC_NUMBER (R_LARCH_PCREL64_L_HI20, 70)
RELOC_NUMBER (R_LARCH_PCREL_LO12_U, 71)
RELOC_NUMBER (R_LARCH_PCREL_LO12_S, 72)
RELOC_NUMBER (R_LARCH_PCREL_H_LO20, 73)
RELOC_NUMBER (R_LARCH_PCREL_H_HI12, 74)
RELOC_NUMBER (R_LARCH_GOT32_HI20, 75)
RELOC_NUMBER (R_LARCH_GOT64_L_HI20, 76)
RELOC_NUMBER (R_LARCH_TLSIE32_HI20, 77)
RELOC_NUMBER (R_LARCH_TLSIE64_L_HI20, 78)
RELOC_NUMBER (R_LARCH_TLSLE64_L_HI20, 79)
RELOC_NUMBER (R_LARCH_TLSLE64_L_LO12, 80)
RELOC_NUMBER (R_LARCH_TLSLE64_H_LO20, 81)
RELOC_NUMBER (R_LARCH_TLSLE64_H_HI12, 82)
RELOC_NUMBER (R_LARCH_TLSGD32_HI20, 83)
RELOC_NUMBER (R_LARCH_TLSGD64_L_HI20, 84)
RELOC_NUMBER (R_LARCH_B16, 85)
RELOC_NUMBER (R_LARCH_B21, 86)
RELOC_NUMBER (R_LARCH_B26, 87)
RELOC_NUMBER (R_LARCH_BL26, 88)
RELOC_NUMBER (R_LARCH_JIRL, 89)
